...
**Note:** If the original download link fails, use this alternative: https://data.caltech.edu/records/mzrjq-6wc02
...
**Note:** If the original download links fail, use this alternative: https://github.com/jhpohovey/StanfordCars-Dataset
...
**Note:** If the original download links fail, use this alternative: https://huggingface.co/datasets/Veiiaj3dad/CLIP-Prompt-learning-sun397/tree/main
